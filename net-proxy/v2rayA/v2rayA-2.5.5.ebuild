...
src_install() {
	...
	newinitd "${S}"/install/universal/v2raya.initd v2raya
	newinitd "${S}"/install/universal/v2raya-user.initd v2raya-user
	newconfd "${S}"/install/universal/v2raya.confd v2raya
	newconfd "${S}"/install/universal/v2raya-user.confd v2raya-user
