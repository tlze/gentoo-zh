...
206c30da5545dba38a29ccbc752dec94/TencentMeeting_0300000000_${PV}_arm64_default.publish.deb
		-> ${P}_arm64.deb )
	loong? ( https://updatecdn.meeting.qq.com/cos/\
23810840e7e8bb38536b2a59ae811343/TencentMeeting_0300000000_${PV}_loongarch64_default.publish.deb
		-> ${P}_loongarch64.deb )
"
